...
Type your destination into the <input id="togeocode" type="textbox" placeholder="Destination"> box and hit <input type="button" value="Find" onclick="codeAddress(&#39;images/mydest.png&#39;)"><br>
